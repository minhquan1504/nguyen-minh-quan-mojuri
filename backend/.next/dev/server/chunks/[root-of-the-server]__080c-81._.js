...
"[project]/backend/app/api/products/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GET(request) {
    ...
    const filtered = __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["products"].filter((product)=>{
...
async function POST(request) {
    ...
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["productSchema"].safeParse(body);
    if (!parsed.success) {
    ...
    const product = {
        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createId"])("prod"),
        ...parsed.data,
        slug: parsed.data.slug ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slugify"])(parsed.data.name),
        createdAt: new Date().toISOString()
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["products"].unshift(product);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__080c-81._.js.map