...
async function POST(request) {
    try {
        ...
        try {
            const { data: existingUser, error: checkError } = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("users").select("*").eq("email", email.toLowerCase()).maybeSingle();
            if (checkError) {
            ...
            if (!existingUser && !checkError) {
                ...
                const { data: createdUser, error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("users").insert([
                    newUser
                ]).select().single();
                if (insertError) {
                    throw insertError;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03owpt7._.js.map