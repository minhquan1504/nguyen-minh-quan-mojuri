...
"[project]/backend/app/api/contacts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("contacts").select("*").order("createdAt", {
            ascending: false
        });
        if (error) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonResponse"])({
                items: __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contacts"]
            });
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonResponse"])({
            items: data || []
...
async function POST(request) {
    ...
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contactSchema"].safeParse(body);
    if (!parsed.success) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["badRequest"])("Invalid contact data", parsed.error.flatten());
    }
    const contact = {
        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createId"])("contact"),
        ...parsed.data,
        isRead: false,
        createdAt: new Date().toISOString()
    };
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("contacts").insert([
            contact
        ]).select().single();
        if (error) {
            console.warn("Supabase insert failed, storing in local memory fallback:", error.message);
            __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contacts"].unshift(contact);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonResponse"])(contact, {
                status: 201
            });
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonResponse"])(data, {
            status: 201
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1gm0vrv._.js.map