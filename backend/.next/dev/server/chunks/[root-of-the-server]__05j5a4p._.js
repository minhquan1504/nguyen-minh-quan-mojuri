...
"[project]/backend/app/api/auth/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loginSchema"].safeParse(body);
        if (!parsed.success) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["badRequest"])("Dữ liệu đăng nhập không hợp lệ", parsed.error.flatten());
        }
        const { email, password } = parsed.data;
        // 1. Try Supabase login
        try {
            let { data: user, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("users").select("*").eq("email", email.toLowerCase()).maybeSingle();
            if (error) {
                ...
                const { data: seededAdmin, error: seedError } = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("users").insert([
                    newAdmin
                ]).select().single();
                if (!seedError) {
                    user = seededAdmin;
        ...
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["users"].find((u)=>u.email.toLowerCase() === email.toLowerCase() && u.password === password);
        if (!user) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonResponse"])({
                message: "Email hoặc mật khẩu không chính xác"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05j5a4p._.js.map