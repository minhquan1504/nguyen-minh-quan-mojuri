                          ...
                          <div className="banner-image">
                            <a href="shop-grid-left.html">
                              <img
                                width={630}
                                height={457}
                                src="/media/banner/banner-1-1.jpg"
                                alt="Banner Image"
                              />
                            </a>
                          </div>
                          ...
                          <div className="banner-image">
                            <a href="shop-grid-left.html">
                              <img
                                width={450}
                                height={457}
                                src="/media/banner/banner-1-2.jpg"
                                alt="Banner Image"
                              />
                            </a>
                          </div>
                          ...
                          <div className="banner-image">
                            <a href="shop-grid-left.html">
                              <img
                                width={630}
                                height={457}
                                src="/media/banner/banner-1-3.jpg"
                                alt="Banner Image"
                              />
                            </a>
                          </div>
                ...
                <div className="intro-wrap">
                  ...
                  <div className="intro-item">
                    ...
                    <div className="content">
                      ...
                      <div className="text">
                        Nullam quis ante. Pellentesque libero tortor, tincidunt
                        et, tinciduntamet est.In hac habitasse platea dictumst.
                  ...
                  <div className="intro-btn">
                    <a
                      href="shop-grid-left.html"
                      className="button button-black button-arrow animation-horizontal"
                    >
                      LEARN MORE
                    </a>
                  </div>
                          ...
                          <div className="banner-image">
                            <a href="shop-grid-left.html">
                              <img
                                width={856}
                                height={496}
                                src="/media/banner/banner-1-4.jpg"
                                alt="Banner Image"
                              />
                            </a>
                          </div>
                          ...
                          <div className="banner-image">
                            <a href="shop-grid-left.html">
                              <img
                                width={856}
                                height={496}
                                src="/media/banner/banner-1-5.jpg"
                                alt="Banner Image"
                              />
                            </a>
                          </div>
