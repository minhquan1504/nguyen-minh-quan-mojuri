export default function BlogListRight(){
    return(
        <>
      ...
      <div id="content" className="site-content" role="main">
        <div className="section-padding">
          <div className="section-container p-l-r">
            <div className="row">
              <div className="col-xl-9 col-lg-9 col-md-12 col-12 posts-column">
                  ...
                  <div className="post-entry post-wapper">
                    ...
                    <div className="post-content">
                      ...
                      <div className="post-excerpt">
                        ...
                        non adipiscing dolor urna a orci. non, velit. Etiam
                  ...
                  <div className="post-entry post-wapper">
                    ...
                    <div className="post-content">
                      ...
                      <div className="post-meta">
                        ...
                        <span className="post-time">
                          <i className="icon_clock_alt" /> August 16, 2023
                        </span>
                        <span className="post-comment">
                          <i className="icon_comment_alt" /> 4 Comments
                        </span>
                      </div>
                      <div className="post-excerpt">
                        Sed mollis, eros et ultrices tempus, mauris ipsum
                  ...
                  <div className="post-entry post-wapper">
                    ...
                    <div className="post-content">
                      ...
                      <div className="post-meta">
                        ...
                        <span className="post-time">
                          <i className="icon_clock_alt" /> October 04, 2023
                        </span>
                        <span className="post-comment">
                          <i className="icon_comment_alt" /> 3 Comments
                        </span>
                      </div>
                      <div className="post-excerpt">
                        Sed mollis, eros et ultrices tempus, mauris ipsum
                  ...
                  <div className="post-entry post-wapper">
                    ...
                    <div className="post-content">
                      ...
                      <div className="post-meta">
                        ...
                        <span className="post-time">
                          <i className="icon_clock_alt" /> October 20, 2023
                        </span>
                        <span className="post-comment">
                          <i className="icon_comment_alt" /> 1 Comment
                        </span>
                  ...
                  <div className="post-entry post-wapper">
                    ...
                    <div className="post-content">
                      ...
                      <div className="post-meta">
                        ...
                        <span className="post-time">
                          <i className="icon_clock_alt" /> December 11, 2023
                        </span>
                        <span className="post-comment">
                          <i className="icon_comment_alt" /> 5 Comments
                        </span>
                      </div>
                      <div className="post-excerpt">
                        Sed mollis, eros et ultrices tempus, mauris ipsum
              ...
              <div className="col-xl-3 col-lg-3 col-md-12 col-12 sidebar right-sidebar md-b-50">
                {/* Block Post Search */}
