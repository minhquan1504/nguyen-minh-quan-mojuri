...
export default function PageContact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatusMsg("Chúng tôi đã nhận được thông tin khiếu nại và sẽ trả lời trong thời gian sớm nhất.");
      setName("");
      setEmail("");
      setMessage("");
    } catch (err) {
      const message = err instanceof Error ? err.message : "Đã xảy ra lỗi khi gửi thông tin. Vui lòng thử lại.";
      setErrorMsg(message);
    } finally {
      setLoading(false);
    }
                    ...
                    <div className="block block-contact-form">
                      <div className="block-widget-wrap">
                        <div className="block-title">
                          ...
                          {statusMsg && (
                            <div className="alert alert-success" style={{ marginTop: "15px", padding: "10px" }}>
                              {statusMsg}
                            </div>
                          )}
                          {errorMsg && (
                            <div className="alert alert-danger" style={{ marginTop: "15px", padding: "10px" }}>
                              {errorMsg}
                            </div>
                          )}
                        </div>
                            ...
                            <div className="contact-us-form">
                              ...
                              <div className="form-button">
                                <button
                                  ...
                                  className="button"
                                  disabled={loading}
                                  style={{ opacity: loading ? 0.7 : 1, padding: "10px 30px" }}
                                >
